$(function () {
    $("#jqGrid").jqGrid({
        ...
        colModel: [
            ...
            {label: '所属种类', name: 'categoryName', index: 'attribute_category_id', width: 80,align:'center'},
            {label: '名称', name: 'name', index: 'name', width: 80,align:'center'},
            {label: '类型', name: 'inputType', index: 'input_type', width: 80,hidden:true,align:'center'},
            {label: '值', name: 'value', index: 'value', width: 80,hidden:true,align:'center'},
