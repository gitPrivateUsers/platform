$(function () {
    $("#jqGrid").jqGrid({
        ...
        colModel: [
            ...
            {label: '商品序列号', name: 'goodsSn', index: 'goods_sn', width: 80, hidden: true,align:'center'},
            {label: '名称', name: 'name', index: 'name', width: 160,align:'center'},
            {label: '品牌', name: 'brandName', index: 'brand_id', width: 120,align:'center'},
            {label: '关键字', name: 'keywords', index: 'keywords', width: 80, hidden: true,align:'center'},
            ...
            {
                label: '添加时间', name: 'addTime', index: 'add_time', width: 80,align:'center', formatter: function (value) {
            ...
            {label: '商品单位', name: 'goodsUnit', index: 'goods_unit', width: 80,align:'center'},
            ...
            {label: '销售量', name: 'sellVolume', index: 'sell_volume', width: 80,align:'center'},
            {label: '主product_id', name: 'primaryProductId', index: 'primary_product_id', width: 80, hidden: true},
            {label: '单价', name: 'unitPrice', index: 'unit_price', width: 80,align:'center'},
            ...
            {
                label: '限购', name: 'isLimited', index: 'is_limited', width: 80,align:'center',formatter: function (value) {
                return transIsNot(value);
            }
            },
            {
                label: '热销', name: 'isHot', index: 'is_hot', width: 80,align:'center',formatter: function (value) {
                return transIsNot(value);
            }
            }],
        viewrecords: true,
