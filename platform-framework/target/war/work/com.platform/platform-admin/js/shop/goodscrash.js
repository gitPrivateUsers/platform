$(function () {
    $("#jqGrid").jqGrid({
        ...
        colModel: [
            ...
            {label: '搭配商品', name: 'goodsCrashName', index: 'goods_crash_id', width: 80,align:'center'},
            {label: '搭配产品', name: 'goodsSpecificationValue', index: 'product_crash_id', width: 80,align:'center'},
            {label: '搭配商品价格，需要小于原始价格', name: 'retailCrashPrice', index: 'retail_crash_price', width: 80,align:'center'}],
        viewrecords: true,
        height: 385,
        rowNum: 10,
        rowList: [10, 30, 50],
